...
const completedResponse = {
  ...
  diagnostic_probe: {
    scenario_id: scenarioId,
    probe_id: "config_fingerprint_diff",
    outcome: "observed",
    safe_summary: "The request-local configuration fingerprint changed.",
    findings: [
      {
        code: "config_fingerprint_diff",
        subject: "CATALOG_SERVICE",
        status: "changed",
        detail: "The cache-invalidation configuration changed after the synthetic release.",
