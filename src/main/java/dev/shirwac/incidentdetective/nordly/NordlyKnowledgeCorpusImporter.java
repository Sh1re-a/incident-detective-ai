...
import dev.shirwac.incidentdetective.rag.RunbookImportItem;
import dev.shirwac.incidentdetective.rag.RunbookImportReport;
import dev.shirwac.incidentdetective.rag.RunbookImportStatus;
...
@Service
@Profile("rag")
public final class NordlyKnowledgeCorpusImporter {
    ...
    public NordlyKnowledgeCorpusImporter(
