...
class NordlyApiTest {
    ...
    void returnsTheSyntheticNordlyWorldFromValidatedResources() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/v1/demo-world"))
                ...
                .andExpect(jsonPath("$.rag_examples.length()").value(7))
                .andExpect(jsonPath("$.rag_examples[0].expected_boundary")
                        .value("rag"))
                .andExpect(jsonPath("$.rag_examples[1].expected_boundary")
                        .value("blocked_before_provider"))
                .andExpect(jsonPath("$.rag_examples[2].category")
                        .value("EMPLOYEE_COMPENSATION"))
                .andExpect(jsonPath("$.rag_examples[2].prompt_en")
                ...
                .andExpect(jsonPath("$.corpus.version")
                        .value("nordly-knowledge-corpus-v1"))
                .andExpect(jsonPath("$.corpus.document_count").value(12))
                .andExpect(jsonPath("$.corpus.chunk_count").value(20))
                .andExpect(jsonPath("$.corpus.approved_documents").value(10))
    ...
    void exposesEverySyntheticDocumentWithAnExplicitRagBoundary()
        ...
        mockMvc.perform(get("/api/v1/knowledge/documents"))
                ...
                .andExpect(jsonPath("$.corpus_version")
                        .value("nordly-knowledge-corpus-v1"))
                .andExpect(jsonPath("$.document_count").value(12))
                .andExpect(jsonPath("$.chunk_count").value(20))
                .andExpect(jsonPath("$.eligible_document_count").value(10))
                .andExpect(jsonPath("$.eligible_chunk_count").value(18))
                ...
                .andExpect(jsonPath("$.documents.length()").value(12))
                ...
                .andExpect(jsonPath("$.documents[10].id")
                        .value("kb-legacy-refund-playbook"))
                .andExpect(jsonPath("$.documents[10].lifecycle")
                        .value("DEPRECATED"))
                .andExpect(jsonPath("$.documents[10].rag_eligibility.eligible")
                        .value(false))
                .andExpect(jsonPath("$.documents[10].rag_eligibility.reason_code")
                        .value("LIFECYCLE_NOT_APPROVED"))
                .andExpect(jsonPath("$.documents[11].id")
                        .value("kb-untrusted-shortcuts"))
                .andExpect(jsonPath("$.documents[11].lifecycle")
                        .value("UNTRUSTED"))
                .andExpect(jsonPath("$.documents[11].rag_eligibility.eligible")
                        .value(false))
                .andExpect(jsonPath("$.documents[11].chunks[0].text")
                        .value(org.hamcrest.Matchers.containsString(
