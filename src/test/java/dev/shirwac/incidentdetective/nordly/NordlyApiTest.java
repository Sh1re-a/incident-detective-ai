...
class NordlyApiTest {
    ...
    void returnsTheSyntheticNordlyWorldFromValidatedResources() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/v1/demo-world"))
                ...
                .andExpect(jsonPath("$.corpus.document_count").value(17))
                .andExpect(jsonPath("$.corpus.chunk_count").value(35))
                .andExpect(jsonPath("$.corpus.approved_documents").value(15))
    ...
    void exposesEverySyntheticDocumentWithAnExplicitRagBoundary()
        ...
        mockMvc.perform(get("/api/v1/knowledge/documents"))
                ...
                .andExpect(jsonPath("$.document_count").value(17))
                .andExpect(jsonPath("$.chunk_count").value(35))
                .andExpect(jsonPath("$.eligible_document_count").value(14))
                .andExpect(jsonPath("$.eligible_chunk_count").value(32))
                ...
                .andExpect(jsonPath("$.documents.length()").value(17))
                ...
                .andExpect(jsonPath("$.documents[14].content_visible")
                        .value(false))
                ...
                .andExpect(jsonPath("$.documents[15].rag_eligibility.eligible")
                        .value(false))
                .andExpect(jsonPath("$.documents[15].rag_eligibility.reason_code")
                ...
                .andExpect(jsonPath("$.documents[16].id")
                        .value("kb-untrusted-shortcuts"))
                .andExpect(jsonPath("$.documents[16].lifecycle")
                        .value("UNTRUSTED"))
                .andExpect(jsonPath("$.documents[16].rag_eligibility.eligible")
                        .value(false))
                .andExpect(jsonPath("$.documents[16].content_visible")
                        .value(false))
                .andExpect(jsonPath("$.documents[16].chunks[0].text")
                        .value(nullValue()))
                .andExpect(jsonPath(
                        "$.documents[16].chunks[0].content_sha256"
                ).value(nullValue()));
    }
